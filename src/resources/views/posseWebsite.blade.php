  ...
  <body>
        ...
        <ul class="header-info">
          <li>
            <a
              ...
              class="cta-button header-ctaLink"
              target="_blank"
          ...
          <section id="daily" class="section">
            <div class="section-head">
              <h2 class="title">
                ...
                <span class="title-en">Daily Recode</span>
              </h2>
              <div class="section-lead">
                <p>
                  様々な日々の活動について紹介します。<br />POSSEでは、プログラミングを学んでいくにあたってメンバー同士が共に学習するような時間を数多く設けています。<br />入会時期が半年毎にあるため、縦の繋がりから学べることは非常に多く、この繋がりを意識した班を構成したり、<br />それとは別に同期のみの班を構成して共に学習するようなシステムを採用しています。
                </p>
              </div>
            </div>
            <div class="section-body sb2">
              <div class="container">
                    ...
                    <ul class="splide__list daily-list">
                      <li class="splide__slide daily-item">
                        ...
                        <div class="daily-itemBody">
                          ...
                          <div class="daily-description">
                            <p>
                              全体ミーティングです。<br />各局からのお知らせや、講演会など目白押しです。
                            </p>
                          </div>
                        </div>
                      </li>
                      <li class="splide__slide daily-item">
                        ...
                        <div class="daily-itemBody">
                          ...
                          <div class="daily-description">
                            <p>
                              期生関係なくzoomを繋ぎ、わからないところを先輩に質問できます。わかるまで丁寧に教えてくれます。
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li class="splide__slide daily-item">
                        ...
                        <div class="daily-itemBody">
                          ...
                          <div class="daily-description">
                            <p>
                              メンターさんからのアドバイスを受けることができます。<br />毎回得る知識が多く、とてもありがたい機会です。
                            </p>
                          </div>
                        </div>
                      </li>
    ...
    <section class="cta">
      ...
      <div class="cta-content">
        <p>
          公式LINE にてご質問を随時受け付けております。<br />詳細や POSSE
          最新情報につきましては、公式 LINE にてお知らせ致しますので<br />下記ボタンより友達追加をお願いします！
        </p>
      </div>
    ...
    <footer class="footer">
      <div class="footer-inner">
        ...
        <a
          href="#"
          class="footer-corporateLink"
          target="_blank"
          rel="noopener noreferrer"
          >POSSE 公式サイト
          <img src="./assets/img/icon-external-link-primary.svg" alt="" />
        </a>
        <ul class="footer-snsList">
          <li class="footer-snsItem">
            <a
              href="#"
              class="footer-snsLink"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
